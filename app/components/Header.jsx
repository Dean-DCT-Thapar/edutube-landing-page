...
const pages = ['LIBRARY', 'ARCHIVE', 'NPTEL'];
const links = {
  'LIBRARY' : 'https://cl.thapar.edu',
  'Latest' : 'https://nptel.ac.in/',
  'Github' : 'https://shodhratna.thapar.edu:8443/jspui/'
}
    ...
    <AppBar sx={{backgroundColor:"#E0A75E"}} position="sticky">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img className="h-16 ml-5" src="/thaparLogo.webp"/>
